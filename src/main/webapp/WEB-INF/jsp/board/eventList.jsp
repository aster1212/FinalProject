...
<div id="boardListTitle">EVENT</div>
<br>
	<c:choose>
		...
		<c:otherwise>
			<div class="boardList">이벤트가 없습니다.</div>
		</c:otherwise>
	</c:choose>
...
<input id="boardWriteBtn" class="boardBtn pointer" type="button" value="글 쓰기" onclick="window.location='/kingsman/admin/boardWriteForm?bylist=2'">
</c:if>
</div>
<script type="text/javascript">
</script>
