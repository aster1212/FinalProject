...
<div id="boardListTitle">EVENT | ${map.BOARD_TITLE }
...
<input id="delOption" class="detailOption pointer" type="button" value="글 삭제" onclick="window.location='/kingsman/admin/boardDelete?BOARD_NO=${map.BOARD_NO}&status=2'">
</c:if>
...
<c:if test="${memgrade != null && memgrade == 99 }">
<input id="detailBoardWriteBtn" class="boardBtn pointer" type="button" value="글 쓰기" onclick="window.location='/kingsman/admin/boardWriteForm?bylist=2'">
</c:if>
</div>
<br>
	<c:choose>
